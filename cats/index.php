  ...
  <body>
    ...
    <div id="container" style="margin-top:0px;">
      <div class="dcordchannel">Cat Wall<div>Welcome to to the wall of cats, I'll add as many photos I take here of my cats :3</div></div>
        <div class='dcord2'>
        <div style="z-index: 129059382;"><user style='--icon: url(https://cdn.discordapp.com/avatars/741823940061560944/8730cfd2557617a015a8cb776317f2a8?size=1024);'>Ashlyn</user>
        <time>
          <?php echo exec("date '+%r'");?>
        </time>
        <?php 
        $dirname = "./!f/";

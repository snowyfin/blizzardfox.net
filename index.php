    ...
    <div id="container">
      ...
      <div id="flex" style="position:relative;">
        <div id="tab" style="text-align:center;position:absolute;margin-top:40px;width:180px;height:215px;left:-100px;z-index: 1;border-radius: 10px;">
          ...
          <div class="tabs title-bar" style="color: white;">Minecraft</div>
          <div class="tabs title-bar" style="color: white;" onclick="window.location.href = '/!g/scan3.pdf';">Journal</div>
          <div class="tabs title-bar" style="color: white;">Projects</div>
          <div class="tabs title-bar" style="color: white;">Collections</div>
          <div class="tabs title-bar" style="color: white;" onclick="window.location.href = 'https://portfolio.snowf.in';">Student Portfolio</div>
        </div>
        <div id="tab" style="text-align:center;position:absolute;margin-top:420px;width:180px;height:215px;left:-50px;z-index: 1;border-radius: 10px;">
          ...
          <div class="tabs title-bar" style="color: white;">Video Games</div>
        ...
        <div class="gbsblue" style="width:230px;height:270px;font-size: 20px;position:absolute;top:1000px;;left:90px;transform:rotate(2.5deg);z-index:990;padding:30px;">
          <div>
            <img src="https://minotar.net/body/snowyfin/100.png" style="position: absolute;left:10px;" width="100px">
            <img src="https://minotar.net/armor/body/OchacoUravity/100.png" style="position: absolute;right:10px;" width="100px">
          </div>
        </div>
        ...
        <div style="position:absolute; margin-top:-135px; margin-left: 430px;">
          <p style="font-family:'Pixelated MS Sans Serif';font-size: 60px;text-align: center;color:black;">BLIZZARDFOX.NET</p>
        </div>
        ...
        <div>
          ...
          <div class="window" style="margin-left:20px;margin-right:130px;margin-bottom: 10px;">
            ...
            <div style="display:flex;margin-left:auto;margin-right:auto;position:relative; width: 100%;max-height: 400px;overflow:auto;">
              <div style="order:1;margin:auto;width:50%;"> 
                <img class="crt" src="/!f/DizzyHornsToonRotate.gif" style="position:relative;order:1;margin:5px;width:100%;">
          ...
          <div style="position:relative;margin-left: 560px;margin-top:-400px;width: 100px;height: 400px;z-index: 10;">
          <div style="text-align: center;">
            <div style="position:absolute;position: relative;display:inline-block">
              <marquee direction="down" scrolldelay="10s" scrollamount="0" behavior="alternate">
                <div style="display: inline-block;">
                ...
                <div style="display: inline-block;">
                  <a href="https://ginder.neocities.org" target="_blank">
                    <img src="https://i.ibb.co/QFVkRQs/button-4.png">
                  </a>
                </div>
                <div style="display: inline-block;">
                ...
                <div style="display: inline-block;">
                  <a href="https://scenariopla.net">
                    <img src="https://scenariopla.net/button.gif" style="display: block; margin-left: auto; margin-right: auto;">
                  </a>
                </div>
                <div style="display: inline-block;">
                  <a href="http://bisha.neocities.org">
                    <img src="http://bisha.neocities.org/images/bisha.gif">
                  </a>
              </marquee>
            </div>
          </div>
        ...
        <aside class="omori" style="margin-left:-245px;margin-top:400px;height: 300px;width:270px;overflow: auto;text-align: center;transform:rotate(5deg);z-index: 3;">
          <div style="position:relative;margin:5px;">
            ...
            <b>Obsessed <br>album: Wallsocket</b>
          </h>
          <a href="https://www.youtube.com/watch?v=k9ynZnEBtvw" target="_blank">
            <img class="cover" src="https://blizzardfox.net/cdn/ALBUM-COVERS/5f5f967600ac3bca6e7007ae6c368dfa.jpg" style="max-width: 200px;padding-bottom: 10px;">
